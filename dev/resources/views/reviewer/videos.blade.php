                    ...
                    if (response.status === "OK"){
                        ...
                        $.each(response.data, function (index,element) {
                            view_jurnal += '<div class="col-sm-12">' +
                                ...
                                '                                            | <a href="{{url('/reviewer/videos/abstract?abs=')}}'+element.no_abstrac+'">Abstract</a>' +
                                '                                            | <a href="{{url('/reviewer/videos/forum?abs=')}}'+element.no_abstrac+'">Q&amp;A Forum ('+element.ttl_qa+')</a>' +
                                '                                        </p>' +
                                '                                    </td>' +
                                '                                </tr>' +
                                '                                </tbody>' +
