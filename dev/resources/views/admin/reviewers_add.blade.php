                    ...
                    <div class="card-body">
                        <form id="formExecute" class="formExecute row">
                            <div class="form-group mb-0 col-sm-12 col-md-4">
                                ...
                                <input type="text" class="form-control border border-default rounded" id="first_name" name="first_name" placeholder="Please fill in...">
                            </div>
                            <div class="form-group mb-0 col-sm-12 col-md-4">
                                <label for="nama_tengah" class="col-form-label text-brown"><small><b>Midle Name</b></small></label>
                                <input type="text" class="form-control border border-default rounded" id="middle_name" name="middle_name" placeholder="Please fill in...">
                            </div>
                            <div class="form-group mb-0 col-sm-12 col-md-4">
                                <label for="nama_belakang" class="col-form-label text-brown"><small><b>Last Name</b></small></label>
                                <input type="text" class="form-control border border-default rounded" id="last_name" name="last_name" placeholder="Please fill in...">
                            </div>
                            <div class="form-group mb-0 col-sm-12">
                                <label for="password" class="col-form-label text-brown"><small><b><code>*)</code>Password</b></small></label>
                                <input type="password" class="form-control border border-default rounded" id="password" name="password" placeholder="Please fill in...">
                            </div>
                            <div class="form-group mb-0 col-sm-12">
                                <label for="email" class="col-form-label text-brown"><small><b>E-mail</b></small></label>
                                <input type="text" class="form-control border border-default rounded" id="email" name="email" placeholder="Please fill in...">
                            </div>
        ...
        $(function() {
            $('#formExecute').validate({
                rules: {
                    ...
                    last_name: { lettersonlys: true, },
                    email: { emailfull: true, },
                ...
                messages: {
                    ...
                    last_name: { lettersonlys: "Only alphabet and space only", },
                    email: { emailfull: "E-mail invalid", },
                    password: { required: "Please fill in", },
                },
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        preConfirm: function () {
                            return new Promise(function (resolve) {
                                ...
                                $.ajax({
                                    type: "POST",data:values, url: "{{ url('/api/insertReviewers') }}",
