            ...
            <div class="col-sm-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/admin/authors')}}">Authors</a></li>
                        ...
                        <div class="row text-dark">
                            <div class="col-sm-12 text-center pb-5">
                                <div style="width: 100px; margin-right: auto;margin-left: auto">
                                    <img id="foto" class="rounded-circle border rounded w-100" src="{{empty($data->foto_author) ? \App\Helpers\Helpers::base64_encode_image(asset('img/user_default.jpg')) : \App\Helpers\Helpers::base64_encode_image(asset('upload/author/'.$data->foto_author))}}">
                                </div>
                            </div>
