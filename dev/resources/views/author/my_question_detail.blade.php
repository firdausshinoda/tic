            ...
            <div class="col-sm-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/author/my_question')}}">My Question</a></li>
            ...
            $.ajax({
                ...
                success: function(response)
                {
                    ...
                    if (response.status==="OK"){
                        ...
                        $('#a_nama_comment').html(setName_author(dt_jurnal.qa_nama_depan,dt_jurnal.qa_nama_tengah,dt_jurnal.qa_nama_belakang));
                        ...
                        $.each(response.qa, function (index,element) {
                            ...
                            view_qa_sub += '<table width="100%" cellpadding="5" border="0">' +
                                ...
                                '                                            <td valign="top">' +
                                '                                                <p class="mb-0">' +
                                '                                                    Reply from <a href="'+qa_sub_link_profile+'">'+element.nama_depan+' '+element.nama_belakang+'</a>' +
