...
<div class="wrapper">
    <nav id="sidebar">
        <ul class="list-unstyled components pr-1 pt-5">
            ...
            <li id="i_videos" class="d-none"><a href="{{url('/author/videos')}}" class="pl-sidebar"><i class="far fa-file-video fa-lg mr-3"></i> Videos</a></li>
...
<script type="text/javascript" src="{{ asset('/custom/custom_author.js?version=1')}}"></script>
