                    ...
                    if (response.status === "OK"){
                        ...
                        $.each(response.data, function (index,element) {
                            ...
                            view_jurnal += '<div class="col-sm-12">' +
                                ...
                                '                                    <p>' +
                                '                                        <a href="{{url('/sub')}}/'+element.slug+'/abstract/'+element.no_abstrak+'" target="_blank">Share Link</a>' +
                                '                                        | <a href="{{url('/sub')}}/'+element.slug+'/profile/'+element.no_author+'" target="_blank">Corresponding Author ('+setName_author(element.nama_depan,element.nama_tengah,element.nama_belakang)+')'+
                                '                                        </a>' +
                                '                                    </p>' +
                                '                                </td>' +
                                '                            </tr>' +
