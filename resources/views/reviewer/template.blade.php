...
<head>
    ...
    <link href="{{ asset('/custom/custom_user.css?v=1')}}" rel="stylesheet">
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu shadow shadow-sm" aria-labelledby="dropdownMenuButton" style="right: .5rem;left: unset;">
                            <a class="dropdown-item" href="{{url('/reviewer/account')}}">Account</a>
                            <a class="dropdown-item" href="{{ url('/reviewer/logout') }}">Logout</a>
                        </div>
                    </div>
                </li>
            </ul>
...
<div class="wrapper">
    <nav id="sidebar">
        <ul class="list-unstyled components pr-1 pt-5">
            <li id="i_dashboard"><a href="{{url('/reviewer')}}" class="pl-sidebar"><i class="fas fa-home fa-lg mr-3"></i> Dashboard</a></li>
            <li id="i_notification"><a href="{{url('/reviewer/notification')}}" class="pl-sidebar"><i class="far fa-bell fa-lg mr-3"></i>Notification <span class="badge badge-warning text-light right" id="ttl_notif" style="display: none">0</span></a></li>
            <li id="i_journal"><a href="{{url('/reviewer/journal')}}" class="pl-sidebar"><i class="far fa-copy fa-lg mr-3"></i> Journals</a></li>
            <li id="i_abstract"><a href="{{url('/reviewer/abstract')}}" class="pl-sidebar"><i class="far fa-file-alt fa-lg mr-3"></i> Abstract</a></li>
            <li id="i_videos"><a href="{{url('/reviewer/videos')}}" class="pl-sidebar"><i class="far fa-file-video fa-lg mr-3"></i> Videos</a></li>
            <li id="i_my_question"><a href="{{url('/reviewer/my_question')}}" class="pl-sidebar"><i class="far fa-comment-dots fa-lg mr-3"></i> My Qestions</a></li>
            <li id="i_my_review"><a href="{{url('/reviewer/my_review')}}" class="pl-sidebar"><i class="far fa-comment-alt fa-lg mr-3"></i> My Review</a></li>
        </ul>
    </nav>
...
<script type="text/javascript" src="{{ asset('/custom/custom_user.js?v=1')}}"></script>
<script type="text/javascript" src="{{ asset('/custom/custom_reviewer.js?v=1')}}"></script>
<script type="text/javascript" src="{{ asset('/custom/validation.js?v=1')}}"></script>
<script type="text/javascript">
    function modal(page,str1,str2) {
        loader_show();
        $.ajax({
            type: "POST",headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data: {page:page,str1:str1,str2:str2}, url: "{{ url('/reviewer/modal') }}",
    ...
    function getNotif() {
        $.ajax({
            url:'{{url('api/getNotifReviewer')}}',type: "GET",dataType: 'json',
    ...
    function setActionDelete(str) {
        if (str==="my_question"||str==="notification_reviewer"||str==="jurnal_revisi"){
            reloadTable();
        }
    }
</script>
