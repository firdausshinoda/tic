                    ...
                    if (response.status === "OK"){
                        ...
                        $.each(response.data, function (index,element) {
                            ...
                            view_jurnal += '<div class="col-12 col-sm-12 col-md-6">' +
                                ...
                                '                                            | <a href="{{url('/reviewer/videos/abstract?abs=')}}'+element.no_abstrac+'" target="_blank">Abstract</a>' +
                                '                                            | <a href="{{url('/reviewer/videos/forum?abs=')}}'+element.no_abstrac+'" target="_blank">Q&amp;A Forum ('+element.ttl_qa+')</a>' +
                                '                                        </p>' +
                                '                                    </td>' +
                                '                                </tr>' +
                                '                                </tbody>' +
