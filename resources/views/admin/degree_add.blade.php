                    ...
                    <div class="card-body">
                        <form id="formExecute" class="formExecute">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control border border-default rounded" id="gelar" name="gelar" placeholder="Please fill in...">
                            </div>
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        preConfirm: function () {
                            return new Promise(function (resolve) {
                                ...
                                $.ajax({
                                    type: "POST",data:values, url: "{{ url('/api/insertDegree') }}",
