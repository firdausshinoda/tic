                    ...
                    <div class="card-body">
                        <form id="formExecute" class="formExecute">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control border border-default rounded" id="country" name="country" value="{{$data->negara}}" placeholder="Please fill in...">
                                <input type="hidden" id="id" name="id" value="{{\App\Helpers\Helpers::enkrip($data->id_negara)}}">
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $('#formExecute').validate({
                ...
                messages: {
                    country: { required: "Please fill in", },
                },
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        preConfirm: function () {
                            return new Promise(function (resolve) {
                                ...
                                $.ajax({
                                    type: "POST",data:values, url: "{{ url('/api/updateCountry') }}",
