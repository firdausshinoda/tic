                    ...
                    <div class="card-body">
                        <form id="formExecute" class="formExecute">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control border border-default rounded" id="judul" name="judul" placeholder="Please fill in...">
                            </div>
                            <div class="form-group mb-0">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control border border-default rounded" id="isi" name="isi" placeholder="Please fill in..." rows="3"></textarea>
                            </div>
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        preConfirm: function () {
                            return new Promise(function (resolve) {
                                ...
                                $.ajax({
                                    type: "POST",data:values, url: "{{ url('/api/insertContact') }}",
