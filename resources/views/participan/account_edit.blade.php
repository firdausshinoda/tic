            ...
            <div class="col-sm-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/participan/account')}}">Account</a></li>
                            ...
                            <div class="row text-dark">
                                <div class="col-sm-12 text-center pb-5">
                                    <div style="width: 150px; margin-right: auto;margin-left: auto">
                                        <img id="foto" class="rounded-circle border rounded w-100" src="<?= empty(Session::get('foto_participan')) ? asset('img/user_default.jpg') : asset('/upload/participan/'.Session::get('foto_participan')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control h-min-formaccount" id="midle_name" name="middle_name" value="{{Session::get('nama_tengah')}}" placeholder="Please fill in...">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group">
...
@section('js')
    <script type="text/javascript">
        ...
        function getData() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('/api/getAccountParticipan') }}",
        ...
        $(function() {
            $('#formExecute').validate({
                rules: {
                    ...
                    institution: { required: true, }, birthday: { required: true, }, email: { required: true, emailfull: true, },address: { required: true, },
                    city: { required: true, }, postal_code: { required: true, },phone_number: { required: true, digits: true, minlength: 8, maxlength: 14, },
                },
                messages: {
                    ...
                    last_name: { required: "Please fill in", lettersonlys: "Only alphabet and space only", }, institution: { required: "Please fill in", },
                    birthday: { required: "Please fill in", }, email: { required: "Please fill in", emailfull: "E-mail invalid" },
                    address: { required: "Please fill in", }, city: { required: "Please fill in", }, postal_code: { required: "Please fill in", },
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        preConfirm: function () {
                            ...
                            return new Promise(function (resolve) {
                                ...
                                $.ajax({
                                    type: "POST",data:values, url: "{{ url('/api/updateAccountParticipan') }}",
                                    ...
                                    success: function(response) {
                                        ...
                                        if (response.status === "OK"){
                                            swalWithBootstrapButtons.fire({title: 'Success.', text: response.message, icon: 'success',}).then((result) => {
                                                if (result.value) {
                                                    window.location.replace("{{url('/participan/account')}}");
                                                }
                                            });
                                        } else {
